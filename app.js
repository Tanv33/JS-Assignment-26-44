...
// var number1 = prompt("Enter any number1");
// document.write("number: " + number1 + "</br>");
// document.write("round off value: " + Math.round(number1) + "</br>");
// document.write("floor value: " + Math.floor(number1) + "</br>");
// document.write("ceil value: " + Math.ceil(number1));

// var absValue = prompt("Enter a value");
// var absFinal = Math.abs(absValue);
// document.write("The absolute value of " + absValue + " is " + absFinal);

// var dice = Math.random();
// var improvedNum = (dice * 6) + 1;
// var diceFinal = Math.floor(improvedNum);
// document.write("random dice value: " + diceFinal)

// var coinToss = Math.random()
// var toss = (coinToss * 2) + 1;
// var coinFinal = Math.floor(toss);
// if (coinFinal === 2) {
//     document.write(coinFinal + "</br>" + "random coin value: Heads");
// }
// if (coinFinal === 1) {
//     document.write(coinFinal + "</br>" + "random coin value: Tails");
...
// var askWeight = prompt("Enter your weight in kilograms");
// document.write("The weight of user is " + askWeight);
...
// if (guess == secret) {
//     document.write("Congratulations </br>you have Guess right");
// } else {
...
// var today = new Date();
// var past = new Date("April 13, 2021")
